...
- (void)commonInit
{
    ...
    for(int i = 0; i < NUMBER_OF_DAY_BY_WEEK; ++i){
        ...
        label.textColor = [UIColor colorWithRed:10./256. green:147./256. blue:157./256. alpha:1.];
        label.font = [UIFont fontWithName:@"CompassRoseCPC-Bold" size:14];
    }
    
    UIImageView *separatorLine = [[UIImageView alloc]initWithFrame:CGRectMake(0, self.frame.size.height - 3,self.frame.size.width, 1)];
    [separatorLine setImage:[UIImage imageNamed:@"white-line-1px"]];
