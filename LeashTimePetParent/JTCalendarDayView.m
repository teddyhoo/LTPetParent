...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    //NSLog(@"day view init with frame: %f, %f, %f, %f",frame.origin.x,frame.origin.y,frame.size.width,frame.size.height);
    [self commonInit];
...
- (void)commonInit
{
    ...
    
    {
        ...
        _textLabel.font = [UIFont fontWithName:@"Lato-Regular" size:16];
    }
