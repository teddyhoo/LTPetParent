...
- (void)commonInit {
    ...
    self.selectionIndicatorEdgeInsets = UIEdgeInsetsMake(3.0f, 3.0f, 3.0f, 3.0f);
    ...
    self.selectionIndicatorBoxLayer.borderWidth = 3.0f;
    self.selectionIndicatorBoxOpacity = 0.4;
